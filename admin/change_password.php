...
{
    $sql=mysqli_query($con,"SELECT password FROM  admins where  email='".$_SESSION['alogin']."'");
    $num=mysqli_fetch_array($sql);
    if($num>0)
{
    $adminname=$_POST['adminname'];
$_SESSION['adminname']=$adminname;
 $con=mysqli_query($con,"update admins set name='$adminname', updationDate='$currentTime' where email='".$_SESSION['alogin']."'");
...
{
$sql=mysqli_query($con,"SELECT password FROM  admins where password='".md5($_POST['password'])."' && email='".$_SESSION['alogin']."'");
$num=mysqli_fetch_array($sql);


if($num>0)
{
 $con=mysqli_query($con,"update admins set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where email='".$_SESSION['alogin']."'");
                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <?php if(isset($_POST['submit']) || isset($_POST['namesubmit']))
{?>
